    ...
    <>
      <div className="flex h-screen flex-col lg:flex-row">
        <div className="lg:w-1/2 w-full flex items-center justify-center px-40 py-16 lg:p-72 lg:bg-green-300">
          <h1 className="lg:text-8xl xl:text-9xl text-slate-800 lg:font-medium text-7xl font-medium mx-auto text-center lg:text-left">
            Binar Car Rental
          </h1>
        </div>
        <div className="lg:w-1/2 w-full flex flex-col items-center justify-center">
          <form className="grid grid-cols-1 gap-4 p-6 lg:w-7/12  w-1/2 shadow bg-slate-50">
            ...
            />
            <p
              className="justify-self-center text-red-500"
              ref={notificationRef}
            >
              {notification}
            </p>
            <button
              ...
              onClick={(event) => onClickRegisterHandler(event)}
            >
              Sign Up
            </button>
          </form>
